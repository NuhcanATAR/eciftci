...
class PlotsNoteExplanationInputWidget extends StatelessWidget {
  const PlotsNoteExplanationInputWidget(
      {required this.plotsNoteModel, super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextFormField(
        ...
        controller: plotsNoteModel.noteExplanationController,
