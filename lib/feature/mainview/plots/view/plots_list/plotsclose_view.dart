...
class PlotsCloseListView extends StatefulWidget {
  const PlotsCloseListView({super.key});

  @override
  State<PlotsCloseListView> createState() => _PlotsCloseListViewState();
}

class _PlotsCloseListViewState extends MainPlotsBase<PlotsCloseListView> {
  @override
  ...
  Widget get buildPlotsListNoWidget => NoPlotsView(
        title: PlotsViewStrings.noClosePlotsListTitleText.value,
        subTitle: PlotsViewStrings.noClosePlotsListSubTitleText.value,
      );
}
