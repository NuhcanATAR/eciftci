...
class UserPhoneNumberInputWidget extends StatelessWidget {
  const UserPhoneNumberInputWidget({required this.modelService, super.key});
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintText: EGuideViewStrings.phoneNumberInputText.value,
