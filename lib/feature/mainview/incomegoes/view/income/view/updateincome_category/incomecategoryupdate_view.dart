...
class IncomeCategoryUpdateView extends StatefulWidget {
  ...
  @override
  State<IncomeCategoryUpdateView> createState() =>
      _IncomeCategoryUpdateViewState();
}

class _IncomeCategoryUpdateViewState
    extends MainIncomeCategoryBase<IncomeCategoryUpdateView> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const LabelMediumMainColorText(
          text: "Gelir Kategorisi Güncelle",
          textAlign: TextAlign.center,
        ),
      ),
      body: BlocConsumer<IncomeCategoryCubit, MainIncomeCategoryState>(
        listener: incomeCategoryUpdateListenerBloc,
        builder: (context, state) {
          return Form(
            key: incomeCategoryModelService.formIncomeCategoryUpdateKey,
            child: Padding(
